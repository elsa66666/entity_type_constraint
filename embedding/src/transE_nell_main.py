...
def main():
    ...
    # ===== NELL995 v1 ===== #
    parser.add_argument('--dataset', type=str, default='nell_v1_ind', help='dataset name')
    ...
    parser.add_argument('--each_axis_dim_for_attribute_embedding', type=int, default=64, help=' ')
    parser.add_argument('--axis_for_attribute_embedding', type=int, default=1, help='axis for attribute embedding')
    parser.add_argument('--dim_for_attribute_embedding', type=int, default=64)
