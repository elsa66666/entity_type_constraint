...
def train(model_args, data):
    ...
    # extract data
    triplets, paths, n_relations, n_attributes, neighbor_params, path_params, attribute_vectors = data
    ...
    # define the model
    model = PathCon(args, n_relations, n_attributes, neighbor_params, path_params, attribute_vectors)
    ...
    dataframe = pd.DataFrame({'epoch': epoch_result_list,
