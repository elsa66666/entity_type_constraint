...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='wn18rr_v1_ind', help='dataset name')
    ...
    # settings for using transE embedding, 1*100 dim
    parser.add_argument('--use_attribute_vector', type=bool, default=True, help='whether use attribute embedding')
    parser.add_argument('--each_axis_dim_for_attribute_embedding', type=int, default=100, help=' ')
    parser.add_argument('--axis_for_attribute_embedding', type=int, default=1, help='axis for attribute embedding')
    parser.add_argument('--dim_for_attribute_embedding', type=int, default=100)
