...
def load_data(model_args):
    global args, entity_dict, relation_dict, attribute_dict, n_attributes
    args = model_args
    directory = '../data/' + args.dataset + '/'
    print('Using raw model, the current dataset is: ', args.dataset)
    ...
    return triplets, paths, len(relation_dict), n_attributes, neighbor_params, path_params
